...
//!
//! Foras allows custom infix and prefix operators with configurable
...
impl OperatorTable {
    /// Create a new operator table with default Foras operators
    pub fn new() -> Self {
        let mut table = Self::default();

        // Default Foras operators (hardcoded from original implementation)
    ...
    /// In Foras, higher precedence numbers bind LESS tightly, so we check them first
