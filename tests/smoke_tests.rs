...
use foras::{Parser, ProverBuilder};
...
"#;
    ...
    assert!(matches!(result, foras::ProofResult::Proof { .. }),
...
"#;
    ...
    assert!(matches!(result,
        foras::ProofResult::Proof { .. } |
        foras::ProofResult::Saturated { .. } |
        foras::ProofResult::ResourceLimit { .. }));
}
